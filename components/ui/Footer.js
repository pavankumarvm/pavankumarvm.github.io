        ...
        <div className={styles.inner}>
          <div className={styles.left}>
            <Link href="/" className={styles.logo}>
              ...
              <span className={styles.logoText}>Pavankumar Maurya</span>
            </Link>
            <p className={styles.tagline}>Building products with purpose.</p>
          </div>

          <div className={styles.center}>
            <p className={styles.copy}>&copy; {year} Pavankumar Maurya</p>
          </div>
